        ...
        Chart {
            ForEach(sampleAnalytics) { item in
                ...
                if isLineGraph{
                    ...
                    .foregroundStyle(Color.blue.opacity(0.1)) // Set the opacity of the area
                    .interpolationMethod(.catmullRom)
                }
                        ...
                        DragGesture()
                            .onChanged{value in
                                ...
                                if let date: Date = proxy.value(atX: location.x){
                                    ...
                                    if let currentItem = sampleAnalytics.first(where: {item in calender.component(.hour, from: item.hour) == hour
                                    }){
